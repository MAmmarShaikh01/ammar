...
function CommentSection() {
  ...
  const [comments, setComments] = useState([
    { id: 1, name: "Alex", text: "Great article! Keep it up!" , date: "12/12/2024 , 5:05:27 PM" },
    { id: 2, name: "John", text: "Very informative. Thanks for sharing!" , date: "12/12/2024 , 5:05:27 PM" },
  ]);
